...
def get_IV(IVlist, trace_id, timestart, timeend):
    timeList = []
...
if __name__ == "__main__":
    ...
    IV_trace = '8157_UCF.UCF_Inverter_1.CB_1.S_1.trace_id'
    timestart = '10/30/2018 12:00:00 PM'
    timeend = '10/30/2018 3:00:00 PM'

    results = get_IV(pitaglist, IV_trace, timestart, timeend)
